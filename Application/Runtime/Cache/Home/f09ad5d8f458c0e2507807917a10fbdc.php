...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/wechat/Public/css/bootstrap3.css">
...
<div  >
    <div class="">
        <div class="">
            ...
            <form class="form-inline" role="form" action="/wechat/index.php/Home/LaunchActivity/launch" action="/wechat/index.php/Home/LaunchActivity/launch" method="post" id="form">
                <div class="modal-body">
                    <div class="form-group">

                            <input size="16" type="text"  readonly class="form_datetime form-control" name="begintime" id="startDateTime" placeholder="Start Time">

                    </div>
                    <div class="form-group">
                        <input size="16" type="text"  readonly class="form_datetime form-control" name="endtime" id="appDateTime" placeholder="End Time">
                    </div>
                    ...
                    <div class="form-group" style="margin-top: 20px;">
                        <p>
                            ...
                            <input type="text" id="amount"  value="0" name="price"style="border:0; color:#f6931f; font-weight:bold;">
                        </p>
                            ...
                            <li class="dropdown" style="border-radius: 30px;width:100%;">
                                ...
                                <ul class="dropdown-menu">
                                    <div class="form-group">
                                        ...
                                        <select multiple class="form-control" style="height:200px; " onchange="showItme()" name="people" id="selectPeople">
                ...
                <div class="modal-footer">
                    <center>
                        <button type="button" class="btn btn-info" style="width:60%;height: 50px;margin-top: 40px;font-size: 2rem;" id="submitbtn">
                            confirm
                        </button>
                    </center>
                ...
                <input name="shopid" value="1" style="display: none;" />
            </form>
        </div><!-- /.modal-content -->
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#startDateTime").mobiscroll(optDateTime).datetime(optDateTime);
    ...
    $("#submitbtn").click(function(){
        ...
        name = $("#name").val();
       if( startDateTime&&appDateTime&&name){
            $("#form").submit();
       }else{
