...
<html  style="font-size: 124.2px;">
 <head>
     ...
     <link rel="stylesheet" href="/wechat/Public/css/find.css" />
 ...
 <body >
    ...
    <header class="index-3O8rT">
     <div class="index-MAORp">
        <div class="index-3vsmj">
           <div><a href="<?php echo U('Person')?>"><img class=" personimg" src="/wechat/Public/resouce/img/20170522200815.png" /></a></div>
           &nbsp;&nbsp;&nbsp;&nbsp;<span class="index-1cnKa place" >湖南科技大学逸夫楼</span>
    ...
    <section infinite-scroll-disabled="busy" infinite-scroll-distance="60" infinite-scroll-immediate-check="false" class="shoplist" style="clear:both;">
     <?php if(is_array($activity)): $i = 0; $__LIST__ = $activity;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><section class="index-container_2XMzI shop-0">
        <div class="logo-container_1XLJl_0">
         <div class="logo-main_1kulr_0">
          <a href="<?php echo U('ChineseStudent/Activity')?>">
          <img alt="<?php echo ($vo['shop']['Name']); ?>" class="logo-logo_2XR1m_0" src="/wechat/Public/resouce/img/shop/<?php echo ($vo['shop']['Image']); ?>" />
          <!---->
          </a>
         </div> 
         <!---->
      ...
      <div class="index-main_2HHPe">
         <section class="index-line_1Zyr1">
          <h3 class="index-shopname_3_J4F index-premium_eGB7C"> <?php echo ($vo['Subject']); ?> </h3>
          <div class="index-supportWrap_VWrQG">
           <div class="activity-container_2EaDo_0 activity-containerNoWrap_2zBBg_0">
            <i class="activity-activityIcon_1iJyG_0 activity-icononly_3QM3P_0" style="color: rgb(153, 153, 153); border-color: rgb(221, 221, 221);"> <?php echo ($vo['StartTime']); ?>---<?php echo ($vo['EndTime']); ?></i>
            <!---->
           </div>
          </div>
         </section> 
